...
class SSTF
{
	public static void main(String []args)
	{
		...
		for(i=0;i<n;i++)
		{
			...
			int temp_seek_time = Math.abs(disk_location[pos] - ini_head);
			System.out.println(disk_location[pos]+"\t\t "+ temp_seek_time);
			ini_head = disk_location[pos];
		}
		
		System.out.println();
		System.out.println("Total Seek Time :"+seek_time);
		System.out.println("Throughput : " + (float)n/seek_time);
	}
}
